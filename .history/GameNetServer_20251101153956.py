...
from GamePacketHeader import GamePacketHeader, HEADER_SIZE
...
class GameNetAPI_Receiver:
    ...
    def _handle_reliable(self, header, payload, addr):
        ...
        if header.sequence_num == self.next_expected_seq:
            ...
            # Now, check the buffer for any subsequent packets that we can add to deque to send to application
