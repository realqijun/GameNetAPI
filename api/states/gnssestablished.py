...
class GNSStateEstablished(GNSState):
    """
    ESTABLISHED happens after sending SYN and receiving the expected ACK for it.
    ...
    - FIN: sends the appropriate ACK back to remote and transition into CLOSE_WAIT.
